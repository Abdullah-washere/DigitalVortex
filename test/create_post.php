...
move_uploaded_file($postImage["tmp_name"], $targetFileName);
      ...
      $query = "INSERT INTO post (title, description,user, img) VALUES ('$postTitle', '$postDescription','$user' ,'$targetFileName')";
...
<body>
    ...
    <?php
           if(isset($_REQUEST["msg"]) && $_REQUEST["msg"] == 1){
            echo '<br> <span class="message error">Post Created Sucessfully</span><br> ';
           }
           ?>
    <!-- content  -->
    <div class="container">
